...
| Year | Exports (bn USD) | Imports (bn USD) | GDP (bn USD) | Capital Stock (2017 USD bn) | Labor Force (million) | Human Capital Index | TFP (2017 = 1) | Consumption (bn USD) | Investment (bn USD) | FX Rate (CNY/USD) | Counterfactual Floating Nominal Rate (CNY/USD) |
| ---: | ---------------: | ---------------: | -----------: | --------------------------: | --------------------: | ------------------: | -------------: | -------------------: | ------------------: | ----------------: | ---------------------------------------------: |
