...
export function AuthenticatedLayout({ children, className, ...rest }: AuthenticatedLayoutProps) {
    ...
    return (
        <div className={className} {...rest}>
            <a
                href="#main-content"
                className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-4 focus:ring-2 focus:ring-offset-2 focus:ring-ring focus:bg-background focus:text-foreground"
            >
