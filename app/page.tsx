...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-xl row-start-2 items-center sm:items-start">
        <Image
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          <a
            className="rounded-full border border-solid border-black/opacity-08 dark:border-white/opacity-145 transition-colors flex items-center justify-center hover:bg-hover-light dark:hover:bg-hover-dark hover:border-transparent font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto md:w-[158px]"
      ...
      <footer className="row-start-3 flex gap-lg flex-wrap items-center justify-center">
        <a
